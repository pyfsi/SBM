...
export Ul=1.5 #Velocity of the liquid  to be introduced in domain 
export Ug=3 # Velocity of the gas to be introduced in domain
...
python TubeBundle_inletModelling_withslip.py $CASE_PATH $startTime $endTime $timeStepSize $tunit $inletName $rhog $rhol $mg $tol_mg $Ul $Ug $intersectBoundary $intersectBubble
