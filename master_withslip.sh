...
python inletModelling_withslip.py $CASE_PATH $startTime $endTime $timeStepSize $tunit $inletName $rhog $rhol $mg $tol_mg $Ul $Ug $intersectBoundary $intersectBubble
